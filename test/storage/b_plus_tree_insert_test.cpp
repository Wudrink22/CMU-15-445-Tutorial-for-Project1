...
//     index_key.SetFromInteger(key);
//     tree.Insert(index_key, rid, transaction);
//     tree.Draw(bpm, "/home/zzh/CMU15445-busthub-2022/B_plus_tree_debug/InsertTest_step" + std::to_string(step++) +
//                        "_insert" + std::to_string(key) + ".dot");
//   }
...
//       tree.FindLeaf(index_key, IndexOpType::SEARCH, nullptr));
